    ...
    - test_passed: #ignore
        ...
        "I am sorry and... I... You. You are here because of master Trembly, am I right?
            ...
            * ["Yes, Godfrey. We need his help."]
                ...
                "He is in the temple. Something important has happened. Maybe they found a way to make the sky healthy again? I hope so." #questComplete:testQuestline_1
...
=== where_is_the_master ===
~ knows_where_is_master = true
"He is inside the temple. Ask for him there." #questComplete:testQuestline_1
    *["Thank you, Godfrey"]
        He starts writing again, while you leave him alone. -> END
...
*[Search for his master]
    You see master Trembly in the great halls of local temple. Now you know where you can find him. #questComplete:testQuestline_1
    -> END