...
//     version 1.4.4
//     from Assets/Cultist.inputactions
//
...
public partial class @Cultist : IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        {
            ...
            ""actions"": [
                {
                    ""name"": ""Move"",
                    ""type"": ""Button"",
                    ""id"": ""7ae290f2-e063-48f9-9157-035f5bd166f4"",
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""6be542d1-e92a-417a-a805-fccda12adafe"",
    ...
    {
        private @Cultist m_Wrapper;
        public PlayerActions(@Cultist wrapper) { m_Wrapper = wrapper; }
    ...
    {
        private @Cultist m_Wrapper;
        public UIActions(@Cultist wrapper) { m_Wrapper = wrapper; }
    ...
    {
        private @Cultist m_Wrapper;
        public CameraActions(@Cultist wrapper) { m_Wrapper = wrapper; }
